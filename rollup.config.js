...
module.exports = {
    ...
    output: [
        {
            format: 'es',
            name: 'i18nBlockLoader',// UMD、IIFE模式中需要 name
            sourcemap: true,
            file: 'dist/i18nBlockLoader.es.mjs'
        },
        {
            format: 'amd',
            name: 'i18nBlockLoader',// UMD、IIFE模式中需要 name
            sourcemap: true,
            file: 'dist/i18nBlockLoader.amd.mjs'
        },
        {
            format: 'cjs',
            name: 'i18nBlockLoader',// UMD、IIFE模式中需要 name
            sourcemap: true,
            file: 'dist/i18nBlockLoader.cjs.mjs'
        },
        {
            format: 'iife',
            name: 'i18nBlockLoader',// UMD、IIFE模式中需要 name
            sourcemap: true,
            file: 'dist/i18nBlockLoader.iife.mjs'
        },
        {
            format: 'umd',
            name: 'i18nBlockLoader',// UMD、IIFE模式中需要 name
            sourcemap: true,
            file: 'dist/i18nBlockLoader.umd.mjs'
        }
    ]
}
